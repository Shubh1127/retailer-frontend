  ...
  return (
    <AppShell active="Desktop app">
      ...
      <div className="max-w-2xl">
        ...
        <h2 className="mt-6 text-[15px] font-semibold tracking-tight text-ink">Windows</h2>
        ...
        {/* ================= macOS ================= */}
        <h2 className="mt-8 text-[15px] font-semibold tracking-tight text-ink">macOS</h2>
        ...
        */}
        {!mac.published ? (
          <section className="mt-2 rounded-xl border border-line bg-surface p-5">
